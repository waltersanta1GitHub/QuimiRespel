...
{
    public class RequerimientoServicioModel
    {
        [BsonId]
        ...
        // Propios Modelo       
        public string DescripcionResiduos { get; set; }
        public string ObservacionesResiduos { get; set; }       
        public List<ReqServicioTablaModelo> TablaResiduos { get; set; }
        public List<Nonu> TablaResiduosContaminadosCon { get; set; }
