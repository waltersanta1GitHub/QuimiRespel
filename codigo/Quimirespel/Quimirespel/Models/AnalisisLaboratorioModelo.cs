...
{
    public class AnalisisLaboratorioModelo
    {
        [BsonId]
        ...
        // Propios
        public List<AnalisisLaboratorioTablaUno> TablaCaracterizacionMuestra { get; set; }
        public List<AnalisisLaboratorioTablaDos> AnalisisFisico { get; set; }
        public List<AnalisisLaboratorioTablaDos> AnalisisQuimico { get; set; }
        public List<AnalisisLaboratorioTablaDos> AnalisisTermico { get; set; }
        public List<AnalisisLaboratorioTablaDos> AnalisisBiologico { get; set; }
