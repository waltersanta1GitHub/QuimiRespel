...
namespace Quimirespel.Plantillas
{
    public class ManejadorPlantillas
    {
        ...
        public static string VisitaTecnicaSeccionMediaDos(VisitaTecnicaModel visitatecnica)
        {
            var contructorVisitaTecnica = new StringBuilder();
