...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <div class="container">
            ...
            <div class="col-sm-12">
                ...
                <div class="col-sm-4">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="col-sm-9">
                                <asp:TextBox ID="txtBuscar" runat="server" CssClass="form-control input-sm" placeholder="Buscar Num Recoleccion">
                                </asp:TextBox>
                            </div>
                            <div class="col-sm-3">
        ...
        <div class="form-group">
            <div class="row">
                <label class="form-control">RECOLECCION DE MUESTRAS</label>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="col-sm-4">
            ...
            <div class="row">
              ...
              <div class="row">
                <div class="col-sm-12">
                    <div class="row">
                        <asp:GridView ID="cadenaCustodiaGrid" Width="100%" runat="server" ShowFooter="true"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="N. MUESTRA">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtNumMuestra" CssClass="form-control" Width="100%" runat="server"></asp:TextBox>
                                    </ItemTemplate>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="col-sm-4">
                                <label>NOMBRE COMPLETO DE QUIIEN ENTREGA LAS MUESTRAS </label>
                            </div>
                            <div class="col-sm-8">
            ...
            <div class="row">
                 <div class="col-sm-12">
                          ...
                          <div class="row">
                              <div class="col-sm-12">
                                  <div class="col-sm-3">
                                   ...
                                   <div class="col-sm-6">
                                       <asp:TextBox ID="txtFechaGenerador" runat="server" CssClass="form-control input-sm text" ></asp:TextBox>
                                   </div>
                                   <div class="col-sm-3">
                                       <label>CARGO</label>
                                   </div>
                         ...
                         <div class="row">
                              <div class="col-sm-12">
                                  <div class="col-sm-3">
                                   ...
                                   <div class="col-sm-6">
                                       <asp:TextBox ID="txtHoraGenerador" runat="server" CssClass="form-control input-sm text" ></asp:TextBox>
                                   </div>
                                   <div class="col-sm-3">
                     ...
                     <div class="col-sm-6">
                          <asp:TextBox ID="txtObservaciones" runat="server" CssClass="form-control input-sm text" TextMode="MultiLine" Rows="5"></asp:TextBox>
                     </div>
                 </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <label class="control-label col-sm-12 sectionheader">
                        4. USO EXCLUSIVO QUIMIRESPEL TRANSPORTADORA S.A.S
                    </label>
                </div>
            </div>   
             <div class="row">
                          ...
                          <div class="row">
                              <div class="col-sm-12">
                                  <div class="col-sm-3">
                                   ...
                                   <div class="col-sm-6">
                                       <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control input-sm text" ></asp:TextBox>
                                   </div>
                                   <div class="col-sm-3">
                                       <label>CARGO</label>
                                   </div>
                         ...
                         <div class="row">
                              <div class="col-sm-12">
                                  <div class="col-sm-3">
                                   ...
                                   <div class="col-sm-6">
                                       <asp:TextBox ID="TextBox2" runat="server" CssClass="form-control input-sm text" ></asp:TextBox>
                                   </div>
                                   <div class="col-sm-3">
                                       <asp:TextBox ID="TextBox3" runat="server" CssClass="form-control input-sm text" ></asp:TextBox>
                                   </div>
                              </div>
                           </div>
                     </div>
                     <div class="col-sm-6">
                          <asp:TextBox ID="TextBox4" runat="server" CssClass="form-control input-sm text" TextMode="MultiLine" Rows="5"></asp:TextBox>
                     </div>
                 </div>
            </div>   
            <div class="row">
                          ...
                          <div class="row">
                              <div class="col-sm-12">
                                  <div class="col-sm-3">
                                   ...
                                   <div class="col-sm-6">
                                       <asp:TextBox ID="TextBox5" runat="server" CssClass="form-control input-sm text" ></asp:TextBox>
                                   </div>
                                   <div class="col-sm-3">
                                       <label>CARGO</label>
                                   </div>
                         ...
                         <div class="row">
                              <div class="col-sm-12">
                                  <div class="col-sm-3">
                                   ...
                                   <div class="col-sm-6">
                                       <asp:TextBox ID="TextBox6" runat="server" CssClass="form-control input-sm text" ></asp:TextBox>
                                   </div>
                                   <div class="col-sm-3">
                                       <asp:TextBox ID="TextBox7" runat="server" CssClass="form-control input-sm text" ></asp:TextBox>
                                   </div>
                              </div>
                           </div>
                     </div>
                     <div class="col-sm-6">
                          <asp:TextBox ID="TextBox8" runat="server" CssClass="form-control input-sm text" TextMode="MultiLine" Rows="5"></asp:TextBox>
                     </div>
                 </div>
            </div>
