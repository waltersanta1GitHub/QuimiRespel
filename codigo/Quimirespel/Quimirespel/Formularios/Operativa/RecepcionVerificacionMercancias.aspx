<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RecepcionVerificacionMercancias.aspx.cs" Inherits="Quimirespel.Formularios.Operativa.RecepcionVerificacionMercancias" %>
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <label class="control-label col-sm-8 sectionheader">2. DESCRIPCIÓN</label>
                    <div class="col-sm-2">
                    </div>
                </div>
            </div>
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-2">
                        ...
                        <asp:TextBox ID="txtNumRecibo" runat="server" CssClass="form-control input-sm text"></asp:TextBox>
                    </div>
                    <div class="col-sm-2">
                        <label class="control-label">FECHA RECEPCIÓN</label>
                        <asp:TextBox ID="txtFechaRecepcion" runat="server" CssClass="form-control input-sm text"></asp:TextBox>
                    </div>
                    <div class="col-sm-1">
                        <label class="control-label">NOMBRE DE MERCANCIA/RESIDUOS</label>
                    ...
                    <div class="col-sm-1">
                        <label class="control-label">LISTA CORRIENTE</label>
                        <asp:TextBox ID="txtListaCorriente" runat="server" CssClass="form-control input-sm text"></asp:TextBox>
                    </div>
                    <div class="col-sm-1">
                        <label class="control-label">ENVIADO A BODEGA</label>
                        <asp:TextBox ID="txtEnviadoABodega" runat="server" CssClass="form-control input-sm text"></asp:TextBox>
                    </div>
                    <div class="col-sm-1">
