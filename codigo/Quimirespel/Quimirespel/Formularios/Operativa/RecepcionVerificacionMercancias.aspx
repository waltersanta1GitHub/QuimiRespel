...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <div class="container">
            ...
            <div class="col-sm-12">
                ...
                <div class="col-sm-4">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="col-sm-9">
                                <asp:TextBox ID="txtBuscar" runat="server" CssClass="form-control input-sm" placeholder="Buscar Verificacion">
                                </asp:TextBox>
                            </div>
                            <div class="col-sm-3">
        ...
        <div class="form-group">
            <div class="row">
                <label class="form-control">RECEPCIÓN, CLASIFICACÍON Y VERIFICACIÓN DE RESIDUOS Y MERCANCÍAS PELIGROSAS</label>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="col-sm-4">
