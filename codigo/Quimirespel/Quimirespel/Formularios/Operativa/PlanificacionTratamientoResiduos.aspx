<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PlanificacionTratamientoResiduos.aspx.cs" Inherits="Quimirespel.Formularios.Operativa.PlanificacionTratamientoResiduos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
 <div class="container">
            ...
            <div class="col-sm-12">
                ...
                <div class="col-sm-4">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="col-sm-9">
                                <asp:TextBox ID="txtBuscar" runat="server" CssClass="form-control input-sm" placeholder="Buscar Num Planificacion">
                                </asp:TextBox>
                            </div>
                            <div class="col-sm-3">
        ...
        <div class="form-group">
            <div class="row">
                <label class="form-control">PLANIFICACIÓN Y  TRATAMIENTO DE RESIDUOS Y MERCANCÍAS PELIGROSAS</label>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="col-sm-4">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <label class="control-label col-sm-12 sectionheader">
                        3. RESIDOS GENERADOS DESPUES DEL TRATAMIENTO
                    </label>
                </div>
            </div>  
            <div class="row">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <label class="control-label col-sm-12 sectionheader">4. INFORMACIÓN DEL REPRESENTANTE DE QUIMIRESPEL TRANSPORTADORA S.A.S</label>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
